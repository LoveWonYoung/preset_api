...
const (
	...
	PRESET_CAP_MANUAL_ISOTP_FRAMING
	PRESET_CAP_DEVICE_RAW_CAN
	PRESET_CAP_MANUAL_TP_MODE
	PRESET_CAP_TP_FRAME_BUILDER
)
...
const (
	PRESET_TP_FLOW_CONTINUE_TO_SEND = iota
	PRESET_TP_FLOW_WAIT
	PRESET_TP_FLOW_OVERFLOW
)
